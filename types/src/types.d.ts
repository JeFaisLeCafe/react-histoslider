import { BarControllerDatasetOptions, ChartData, ChartOptions, ScriptableContext } from "chart.js/auto";
...
export interface BarChartProps {
    ...
    getBarsColors?: (context: ScriptableContext<"bar">) => CanvasGradient | CanvasPattern | string | string[] | CanvasGradient[] | CanvasPattern[];
}
